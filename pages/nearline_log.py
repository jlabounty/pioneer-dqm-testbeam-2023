...
layout = html.Div([
    ...
    dbc.Container([
        ...
        dcc.Download(id="download-nearline-log-csv"),
        dash_table.DataTable(
            id='nearline-log-table',
        ...
        html.Div(id='nearline_file_list_2'),
...
@callback(
    Output("nearline-log-table", 'data'),
    Output("nearline-log-table", 'columns'),
    # Output("run-log", 'data'),
    Input('update-constants', 'n_intervals'), 
    Input('do-update', 'on'),
    Input('update-constants-now', 'n_clicks'),
    Input("nearline-log-table", 'data'),
    Input("nearline-log-table", 'columns'),
...
#     Input('nearline-log-table', 'active_cell')
# )
...
@callback(
    Output('nearline_file_list_2', 'children'), 
    Input('nearline-log-table', 'derived_virtual_selected_rows'),
    Input('nearline-log-table', 'active_cell'),
    Input("run-log", 'data'),
    Input("nearline-files", 'data'),
)
...
@callback(
    Output("download-nearline-log-csv", "data"),
